...
const rowsOrder = [
  ...
  ['ShiftLeft', 'IntlBackslash', 'KeyZ', 'KeyX', 'KeyC', 'KeyV', 'KeyB', 'KeyN', 'KeyM', 'Comma', 'Period', 'Slash', 'ArrowUp', 'Speech'],
  ['ControlLeft', 'lng', 'AltLeft', 'Space', 'Sound', 'ArrowLeft', 'ArrowDown', 'ArrowRight', 'OFF'],
];
